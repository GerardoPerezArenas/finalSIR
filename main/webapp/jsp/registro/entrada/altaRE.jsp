...
function mostrarDestino() {
    ...
    if (tipoEntrada === '') {
        ...
        if (borrarCampos === "" || (borrarCampos !== "" && borrarCampos !== "0")) {
            borrarDestinoOrdinaria();
            borrarProcedenteOtroReg();
            borrarYDeshabilitarExpediente();
        }
        if (document.getElementById("TEOtroReg")) document.getElementById("TEOtroReg").style.display = 'block';
        if (typeof integracionSIRLanbide !== 'undefined' && integracionSIRLanbide == "1") {
            if ($("#TEOtroReg #prueba2").length > 0) {
            ...
            if ($("#unidadDestinoEntradaSIR").length > 0) {
        ...
        if ($("#TEOtroReg #prueba2").length > 0) {
            if (
                ($('#TEOtroReg #prueba2 [name="cod_orgDestino"]').val() != null && $('#TEOtroReg #prueba2 [name="cod_orgDestino"]').val() !== "" ) ||
        ...
        if (document.getElementById("divDatosRegistroSIR")) document.getElementById("divDatosRegistroSIR").style.display = 'block';
        if (document.getElementById("capaTiposEstadoAnotacion")) document.getElementById("capaTiposEstadoAnotacion").style.display = 'none';
        if (document.getElementById("capaTiposEstadoSIR")) document.getElementById("capaTiposEstadoSIR").style.visibility = 'visible';
    } else if (tipoEntrada === '2') {  // Destino procedente de otro registro
        console.log("[mostrarDestino] Caso: DESTINO PROCEDENTE DE OTRO REGISTRO");
        borrarDestinoOtroReg();
        if (document.getElementById("TEOtroReg")) document.getElementById("TEOtroReg").style.display = 'none';
        if (document.getElementById("capaOrigen")) document.getElementById("capaOrigen").style.display = 'block';
        tp1_p3.setPrimerElementoFoco(document.forms[0].cod_uor);
        if (top.menu.modificando == 'S') normalAobligatorio(elementos);
        habilitarTipoDocYRemitente();
        if (document.getElementById('etiquetaTipoRem')) document.getElementById('etiquetaTipoRem').className = "etiqueta";
    ...
    <% } else { %>
    // Caso para resto de anotaciones
